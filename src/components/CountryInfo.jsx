            ...
            {infoCountry.map(info => {
                return (
                    <Grid
                        ...
                        <Grid item md={6} xs={12} data-aos="fade-right" data-aos-duration="1500">
                            <img src={info.flag} alt="flag"/>
                        </Grid>
                        <Grid item md={6} xs={12} className='text-cont' data-aos="fade-left" data-aos-duration="2000">
                            <h2>{info.name}</h2>
